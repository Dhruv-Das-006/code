    ...
    <div className="container mx-auto px-4 py-20 animate-in fade-in duration-1000">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-zinc-900 dark:text-white">Privacy Policy</h1>
        </div>
        ...
        <div className="space-y-12 prose dark:prose-invert max-w-none">
          <section>
            <h2 className="text-2xl font-black text-zinc-900 dark:text-white mb-4 flex items-center gap-3">
              <FiEye className="text-indigo-600" /> 1. Data Collection
            </h2>
          ...
          <section className="p-8 rounded-[40px] bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
            <h2 className="text-2xl font-black text-zinc-900 dark:text-white mb-4">Contact Us</h2>
            ...
            <button className="px-8 py-3 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-bold rounded-full hover:scale-105 transition-all shadow-lg">
              privacy@dcode.dev
            </button>
          </section>
        </div>
